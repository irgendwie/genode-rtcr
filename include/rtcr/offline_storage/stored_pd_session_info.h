...
struct Rtcr::Stored_pd_session_info : Stored_session_info, Genode::List<Stored_pd_session_info>::Element
{
	...
	Stored_pd_session_info(Pd_session_component &pd_session)
	:
	...
	:
		...
		stored_address_space(_stored_address_space->badge,_stored_address_space->bootstrapped,_stored_address_space->size,_stored_address_space->ds_badge,_stored_address_space->sigh_badge),
		stored_stack_area(_stored_stack_area->badge,_stored_stack_area->bootstrapped,_stored_stack_area->size,_stored_stack_area->ds_badge,_stored_stack_area->sigh_badge),
		stored_linker_area(_stored_linker_area->badge,_stored_linker_area->bootstrapped,_stored_linker_area->size,_stored_linker_area->ds_badge,_stored_linker_area->sigh_badge)
	{ 
